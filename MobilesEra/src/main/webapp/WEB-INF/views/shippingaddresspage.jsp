    	...
    	<form:form modelAttribute="shippingAddress">
			<fieldset>
				...
				<div class="form-group">
                    <form:input class="form-control input-lg" type="hidden" path="shipAddId" />                    
				</div>
				<div class="form-group">
                    <form:input type="text" class="form-control input-lg" path="sName" placeholder="Fill your name" autofocus="true" />
                </div>    
                <div class="form-group">    
				...
				<div class="form-group">
                    <form:input type="text" class="form-control input-lg" path="sPrefix" placeholder="Enter the first line of address" />
                </div>
                <div class="form-group">    
